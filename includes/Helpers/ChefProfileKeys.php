...
/**
 * Centralized chef profile meta key definitions.
 */
final class ChefProfileKeys {
	public const FULL_NAME             = 'maklaplace_chef_full_name';
	public const DISPLAY_NAME          = 'maklaplace_chef_display_name';
	public const BIO                   = 'maklaplace_chef_bio';
	...
	public const APPROVAL_DATE         = 'maklaplace_chef_approval_date';
	public const REJECTION_REASON      = 'maklaplace_chef_rejection_reason';
}
