...
final class ChefProfileService {
	...
	public function get_profile( int $user_id ) : ?array {
		...
		return array(
			...
			ChefProfileKeys::WILAYA              => get_user_meta( $user_id, ChefProfileKeys::WILAYA, true ),
			...
			ChefProfileKeys::WHATSAPP            => get_user_meta( $user_id, ChefProfileKeys::WHATSAPP, true ),
	...
	private function sanitize_profile( array $data ) : array {
		return array(
			...
			ChefProfileKeys::WILAYA          => Validation::text( $data['wilaya'] ?? '' ),
			...
			ChefProfileKeys::WHATSAPP        => Validation::text( $data['whatsapp'] ?? '' ),
	...
	private function get_raw_profile( int $user_id ) : array {
		return array(
			...
			'wilaya'          => (string) get_user_meta( $user_id, ChefProfileKeys::WILAYA, true ),
			...
			'whatsapp'        => (string) get_user_meta( $user_id, ChefProfileKeys::WHATSAPP, true ),
